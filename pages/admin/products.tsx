...
export default function ProductsAdminPage() {
  ...
  const [category, setCategory] = useState(""); // dropdown filter
  ...
  return (
    <DashboardLayout>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Button onClick={openCreate}>+ New Product
        </Button>
      </div>
              <Button
          className="mb-6 flex items-center justify-between-3"
          onClick={async () => {
      ...
      <div className="mb-4 flex flex-wrap gap-3 items-center">
        ...
        <Select value={category} onChange={(e) => setCategory(e.target.value)}>
            ...
            <option value="Vegetables">Vege</option>
            <option value="Traditionals">Traditional</option>
            <option value="Fast-Food">FastFood</option>
            <option value="Foriegn">ForeignCuisin</option>
