  ...
  return (
    <div className="px-4 sm:px-6 pt-24 pb-12 max-w-5xl mx-auto">
      ...
      <div className="mb-6 flex items-center justify-between">
        <Link
          href="/"
          className="inline-flex items-center gap-2 rounded-xl border px-3.5 py-2 text-sm hover:bg-neutral-50"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <path d="M10 19l-7-7 7-7" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <div className="text-right">
          <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight">My Account</h1>
          <p className="text-sm text-neutral-500">Profile overview and account actions</p>
        </div>
      </div>
        ...
        <div className="px-6 sm:px-8 pb-8 pt-6">
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl border bg-white p-4">
                <div className="text-xs uppercase tracking-wide text-neutral-500">Role</div>
                <div className="mt-1"><RoleBadge role={(user?.role as string) || "user"} /></div>
              </div>
              <div className="rounded-xl border bg-white p-4">
              ...
              <div className="rounded-xl border bg-white p-4 sm:col-span-2">
                ...
                <ul className="mt-2 text-sm text-neutral-700 list-disc pl-5 space-y-1">
                  ...
                  <li>Two-factor authentication: <span className="font-medium">Not enabled</span></li>
                  {/* <li>Signed in on: {typeof window !== "undefined" ? navigator.platform : "—"} / {typeof window !== "undefined" ? navigator.userAgentData?.brands?.[0]?.brand ?? "Browser" : "Browser"}</li> */}
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-xl border bg-white p-4">
                ...
                <div className="mt-3 grid gap-2">
                  <Link href="/" className="inline-flex items-center justify-between rounded-lg border px-3 py-2 text-sm hover:bg-neutral-50">
                    Home
                    <span>↗</span>
                  </Link>
                  <Link href="/products" className="inline-flex items-center justify-between rounded-lg border px-3 py-2 text-sm hover:bg-neutral-50">
                    Products
                    <span>↗</span>
                  </Link>
                  <Link href="/reservation" className="inline-flex items-center justify-between rounded-lg border px-3 py-2 text-sm hover:bg-neutral-50">
                    Reservations
                    <span>↗</span>
                  </Link>
                  {(user?.role === "admin") && (
                    <Link href="/admin" className="inline-flex items-center justify-between rounded-lg border px-3 py-2 text-sm hover:bg-neutral-50">
                      Admin Dashboard
                      <span>↗</span>
                    </Link>
                  )}
              ...
              {/* <div className="rounded-xl border bg-white p-4">
                <div className="text-xs uppercase tracking-wide text-neutral-500">Support</div>
                <p className="mt-2 text-sm text-neutral-700">
                  Need help? Visit the{" "}
                  <Link href="/help" className="underline">Help Center</Link> or contact{" "}
      ...
      <p className="mt-4 text-xs text-neutral-500">
        Need to update your details? Contact an administrator.
        (Your account information is private and only visible to you and administrators.)
      </p>
    </div>
  );
}
