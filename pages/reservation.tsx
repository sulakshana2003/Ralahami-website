...
export default function ReservationPage() {
  ...
  // Optional: limit max advance booking (e.g., 60 days)
  // const maxDateStr = useMemo(() => format(addDays(new Date(), 60), 'yyyy-MM-dd'), [])
  ...
  // Safety net: if date ever becomes past (pasted/programmatic), clamp to today
  useEffect(() => {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (date < todayStr) {
      setError("You can't select a past date.")
      return
    }
        ...
        <div className="relative mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          {successId ? (
            <div className="rounded-2xl border border-green-200 bg-green-50 p-6">
              ...
              <a
                href="/"
                className="mt-6 inline-block rounded-full bg-black px-5 py-2 text-sm font-medium text-white hover:bg-neutral-800"
              >
                Back to Home
              </a>
            </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={date}
                    min={todayStr}                 // ⟵ block past days
                    // max={maxDateStr}            // ⟵ optional: limit future range
                    onChange={(e) => {
              ...
              <div className="sm:col-span-2">
                <button
                  disabled={submitting}
                  className="w-full rounded-xl bg-black px-5 py-3 text-sm font-medium text-white hover:bg-neutral-800"
                >
